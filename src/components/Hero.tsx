  ...
  return (
    <section title="Hero Section" className="flex flex-col items-center">
      ...
      <h1 className={`text-8xl font-bold font-lexend-mega pt-6`}>
        G<span className="text-gris-claro">A</span>T<span className="text-gris-claro">O</span> {isMobile ? <br /> : null}
        R<span className="text-gris-claro">O</span>J<span className="text-gris-claro">O</span> {isMobile ? <br /> : null}
